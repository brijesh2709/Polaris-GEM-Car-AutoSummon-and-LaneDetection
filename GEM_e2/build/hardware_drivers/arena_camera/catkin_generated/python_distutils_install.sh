...
echo_and_run cd "/home/gem/cuberts_484/src/hardware_drivers/arena_camera"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/gem/cuberts_484/src/hardware_drivers/arena_camera/setup.py" \
     \
    build --build-base "/home/gem/cuberts_484/build/hardware_drivers/arena_camera" \
    install \
    --root="${DESTDIR-/}" \
