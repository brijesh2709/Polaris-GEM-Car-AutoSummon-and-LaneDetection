...
$ roslaunch gem_launch gem_init.launch world_name:="highbay_track.world" x:=-20.5 y:=-21 
...
$ rosrun gem_pure_pursuit_sim auto_summon_backend_server.py 


#### Set up auto summon controller

$ source devel/setup.bash  

$ rosrun gem_pure_pursuit_sim auto_summon_sim.py 
