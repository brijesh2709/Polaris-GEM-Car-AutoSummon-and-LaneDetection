...
xy_csv_path = "IRL_sensor_waypoints_xy.csv"
heading_csv_path = "IRL_sensor_waypoints_heading.csv"
final_csv_path = "IRL_sensor_waypoints.csv"
olat = 40.0928563
olon = -88.2359994
file1 = open("IRL_sensor_waypoints_xy.csv", mode="w", newline="")
file2 = open("IRL_sensor_waypoints_heading.csv", mode="w", newline="")
file3 = open("IRL_sensor_waypoints_lat_lon.csv", mode="w", newline="")
